...
public class MiAgenda extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String numero = request.getParameter("vehiculo");
        if (sesion != null) {
           ...
           System.out.println("personaaaa"+persona.getVehiculos());
         
           if(numero != null) {
        	   VehiculoDAO vehiculoDao = DAOFactory.getFactory().getVehiculoDAO();
               persona.setVehiculos(vehiculoDao.findByVehiculo(persona.getCedula(), numero)); 
